...
export default {
  ...
  methods: {
    ...
    // demo1 列表之间的换位置
    sortableDemo1() {
      const dv1 = document.getElementById('demo1')
      const dv2 = document.getElementById('demo2')
      ...
      new Sortable(dv1, {
        ...
        onEnd: ({ oldIndex, newIndex }) => {
          ...
          const items = this.list.splice(oldIndex, 1)[0]
      ...
      new Sortable(dv2, {
        ...
        animation: 150,
        onEnd: ({ oldIndex, newIndex }) => {
          const items = this.list2.splice(oldIndex, 1)[0]
    ...
    // demo2 列表之内的换位置
    sortableDemo2() {
      const dv3 = document.getElementById('demo3')
      new Sortable(dv3, {
        animation: 150,
        onEnd: ({ oldIndex, newIndex }) => {
          const items = this.list3.splice(oldIndex, 1)[0]
